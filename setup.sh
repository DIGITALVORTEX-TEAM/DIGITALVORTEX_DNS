...
if [ "$MODE" == "1" ]; then
    ...
    echo -e "\033[1;36mLotfan config WireGuard server KHAREJ ra dakhel nano benevisid ya paste konid.\033[0m"
    echo -e "\033[1;36mBa CTRL+O save konid va ba CTRL+X az nano kharej shavid.\033[0m"
    echo -e "\033[1;33m===========================================\033[0m"
